# This is a script that tells the current time and date, hard disk statistics, and prints a randomly generated number
# This is a script that has no user inputs, simply right click and run or use hotkey (shift+f10).
